...
// and 17,408 / 8 = 2,176 CTAs provide more than 17 waves on a 128-SM RTX 4090.
...
/// Prepared A16 routes consuming the exact source NVFP4 gate/up owner on SM89.
pub struct Nvfp4SwiGluOp<A: Sm89Arch = Qwen38_27B> {
...
impl<A: Sm89Arch> Nvfp4SwiGluOp<A> {
    ...
    pub fn new(context: &Arc<CudaContext>) -> GpuResult<Self> {
        ...
        let module = unsafe { kernels::load(context) }
            .map_err(|source| GpuError::module("loading the SM89 NVFP4 SwiGLU module", source))?;
