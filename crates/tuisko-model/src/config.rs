...
fn validate_qwen36<A: Arch>(path: &Path, config: &Qwen36Config) -> CheckpointResult<()> {
...
fn validate_qwen36_hf_quantization<A: Arch>(config_path: &Path) -> CheckpointResult<()> {
...
mod tests {
    use super::{
        modelopt_ignored_targets, qwen36_fp8_targets, qwen36_nvfp4_targets,
        qwen36_quantized_layers, test_quantization_config, validate_config,
    };
    use crate::{CheckpointErrorCode, Qwen35_9B, Qwen36Moe35B, Qwen38_27B};
