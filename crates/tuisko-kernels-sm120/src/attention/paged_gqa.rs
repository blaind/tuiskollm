...
use crate::device::paged_gqa::{
    PREFILL_SHARED_BYTES, PREFILL_THREADS, paged_gqa, paged_gqa_prefill_shared,
};
...
mod tests {
    use super::{
        PREFILL_SHARED_BYTES, PREFILL_THREADS, THREADS, admitted_batch, paged_gqa_ptx_names,
    };
