...
use crate::device::fp8_projection::{qkv_projection, qkv_projection_mma_t16, quantize_activation};
...
mod tests {
    use super::{
        MAX_BATCH, QKV_MMA_K_WORDS, QKV_MMA_OUTPUT_ROWS, QKV_MMA_SHARED_BYTES, QKV_MMA_THREADS,
        QKV_MMA_TOKENS, QKV_THREADS, QKV_WARPS, QUANTIZE_THREADS, fp8_qkv_ptx_names,
    };
    ...
    fn ptx_inventory_has_quantization_and_one_entry_per_route() {
        ...
        assert_eq!(names.len(), MAX_BATCH + 2);
