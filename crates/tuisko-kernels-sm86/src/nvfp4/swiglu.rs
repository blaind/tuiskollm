...
impl PreparedBatchOneRoute {
    fn prepare(module: &kernels::LoadedModule) -> GpuResult<Self> {
        let projection = module
            ...
            .map_err(|source| GpuError::launch("preparing SM86 NVFP4 A16 B=1", source))?;
    ...
    unsafe fn launch(
        ...
        module
            ...
            .map_err(|source| GpuError::launch("launching SM86 NVFP4 A16 B=1", source))
    }
}
...
impl<A: Arch, const TOKENS: usize> PreparedBatchRoute<A, TOKENS> {
    fn prepare(module: &kernels::LoadedModule) -> GpuResult<Self> {
        let projection = module
            ...
            .map_err(|source| GpuError::launch("preparing SM86 NVFP4 A16", source))?;
    ...
    unsafe fn launch(
        ...
        module
            ...
            .map_err(|source| GpuError::launch("launching SM86 NVFP4 A16", source))
    }
}
