...
`B=1..8` and `T=32,64,128,1024`, dense-FP8 down at exact `B=1..8` and `T=1024`, GDN
...
Dense-FP8-SwiGLU `T=32,64,128,1024` and dense-FP8-down `T=1024` cases are `operator/prefill`
