...
pub fn benchmark_fp8_gdn_input(
    ...
    memory.register_owned(
        ...
        weight_bytes,
        "source-native fused GDN Q/K/V/Z",
    )?;
    memory.register_owned(
...
mod tests {
    ...
    fn byte_accounting_covers_the_complete_quantize_projection_path() {
        let weights = Qwen38_27B::GDN_INPUT_ROWS * (Qwen38_27B::HIDDEN + size_of::<u16>());
        let per_token =
            4 * Qwen38_27B::HIDDEN + 2 * size_of::<f32>() + 2 * Qwen38_27B::GDN_INPUT_ROWS;
