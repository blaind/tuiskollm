...
impl BenchmarkWorkload {
    ...
    pub(crate) fn warm_layer_prefill(active_tokens: u64) -> Self {
        Self {
            scope: BenchmarkScope::Layer,
            phase: BenchmarkPhase::Prefill,
            batch_size: None,
    ...
    pub(crate) fn warm_attention_layer_prefill(active_tokens: u64) -> Self {
        Self {
            scope: BenchmarkScope::Layer,
            phase: BenchmarkPhase::Prefill,
            batch_size: None,
    ...
    pub(crate) fn warm_model_mtp(active_tokens: u64, context_tokens: u64) -> Self {
        Self {
            scope: BenchmarkScope::Model,
            phase: BenchmarkPhase::Mtp,
            batch_size: None,
    ...
    pub(crate) fn warm_model_completed_prefix_fallback(
        prompt_tokens: u64,
        message_boundary_tokens: u64,
        followup_tokens: u64,
        output_tokens: u64,
