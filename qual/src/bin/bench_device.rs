...
use tuisko_qual::{
    ...
    benchmark_qwen35_text_endpoint, benchmark_qwen36_fp8_qkv, benchmark_qwen36_gdn_input,
    benchmark_qwen36_gdn_moe_layer,
    benchmark_qwen36_gdn_output,
    benchmark_qwen36_gdn_prepare,
