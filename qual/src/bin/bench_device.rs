...
use tuisko_qual::{
    ...
    benchmark_gdn_output, benchmark_gdn_prepare, benchmark_gdn_recurrence, benchmark_residual_norm,
...
fn run() -> Result<(), Box<dyn Error>> {
    ...
    let suite = arguments
        .next()
        .ok_or("usage: bench-device <residual-norm|fp8-qkv|fp8-gdn-input|fp8-lm-head|fp8-swiglu|fp8-down|gdn-prepare|gdn-recurrence|gdn-output|dense-fp8-mlp|text-endpoint> [SNAPSHOT] [options]")?;
