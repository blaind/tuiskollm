...
use tuisko_qual::{
    ...
    benchmark_qwen35_text_endpoint, benchmark_qwen36_gdn_input, benchmark_qwen36_moe_experts,
    benchmark_qwen36_moe_router, benchmark_qwen36_residual_norm,
