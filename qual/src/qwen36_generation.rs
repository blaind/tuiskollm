...
use std::sync::Arc;
use tuisko_engine::{
    ChatGenerationRequest, EngineError, FinishReason, Qwen36ResidentTextGenerator, SamplingOptions,
};
...
fn verify_owner(
    ...
    if generator.arena_bytes() != 20_402_726_912
...
#[cfg(test)]
mod tests {
    use super::qualify_qwen36_generation;
